...
public class v1_20_R3Impl implements INMSImpl {
   ...
   public void sendEatingAnimation(Player player) {
      try {
         Object entityPlayer = getHandle(player);
         Method dM = entityPlayer.getClass().getMethod("dM");
         Object world = dM.invoke(entityPlayer);
         Method l = world.getClass().getMethod("l");
         Object chunkProvider = l.invoke(world);
   ...
   public void animateDeath(Player player) {
      ...
      try {
         Method dC = entity.getClass().getMethod("dC");
         Method dE = entity.getClass().getMethod("dE");
         Method cp = entity.getClass().getMethod("cp");
         float pitch = ((Number) dC.invoke(entity)).floatValue();
         float yaw = ((Number) dE.invoke(entity)).floatValue();
         float headYaw = ((Number) cp.invoke(entity)).floatValue();
