...
public class v1_8_R3ChunkAdapter implements IChunkAdapter {
    ...
    private Object cloneSection(Object original) {
        try {
            ...
            Method getIdArray = original.getClass().getMethod("getIdArray");
            char[] blockIds = (char[]) ((char[]) getIdArray.invoke(original)).clone();
    ...
    private Object cloneNibbleArray(Object original) throws Throwable {
        Method a = original.getClass().getMethod("a");
        byte[] data = (byte[]) ((byte[]) a.invoke(original)).clone();
