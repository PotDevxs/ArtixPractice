...
public class v1_20_R1ChunkAdapter implements IChunkAdapter {
   ...
   public void cacheChunk(Chunk chunk) {
      ...
      IChunkAccess nmsChunk = ((CraftChunk)chunk).getHandle(ChunkStatus.n);
   ...
   public ChunkSection cloneSection(ChunkSection chunkSection) {
      try {
         ChunkSection newSection = new ChunkSection(chunkSection.h(), (DataPaletteBlock)chunkSection.i());
   ...
   static {
      ...
      try {
         Field fieldE = ChunkSection.class.getDeclaredField("e");
         ...
         Field fieldF = ChunkSection.class.getDeclaredField("f");
         ...
         Field fieldG = ChunkSection.class.getDeclaredField("g");
         ...
         Field sections = IChunkAccess.class.getDeclaredField("m");
