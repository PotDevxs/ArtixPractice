...
public class v1_12_R1PacketListener extends AbstractPacketListener {
   private static final PacketType[] ENTITY_PACKETS;

   public v1_12_R1PacketListener(JavaPlugin plugin) {
      ...
      if (event.getPlayer() != null) {
         if (event.getPacket() != null) {
            ...
            if (type == Server.WORLD_EVENT) {
               ...
               if (!sound.equals(Sound.ENTITY_ARROW_HIT) && !sound.equals(Sound.ENTITY_ARROW_HIT_PLAYER) && !sound.equals(Sound.ENTITY_ARROW_SHOOT) && !sound.equals(Sound.ENTITY_CHICKEN_EGG) && !sound.equals(Sound.ENTITY_SNOWBALL_THROW) && !sound.equals(Sound.ENTITY_PLAYER_HURT) && !sound.equals(Sound.ENTITY_ENDERPEARL_THROW) && !sound.equals(Sound.ENTITY_GENERIC_EAT) && !sound.equals(Sound.ENTITY_GENERIC_DRINK)) {
                  return;
               }
               ...
               entityID = (Integer)event.getPacket().getIntegers().readSafely(0);
               net.minecraft.server.v1_12_R1.Entity nmsEntity = ((CraftWorld)receiver.getWorld()).getHandle().getEntity(entityID);
               if (nmsEntity == null) {
                  return;
               }
