...
public class v1_12_R1PacketListener extends AbstractPacketListener {
   /** Sound names that should be filtered (1.8: BOW, ARROW_HIT... / 1.12+: ENTITY_ARROW_SHOOT, ENTITY_ARROW_HIT...) */
   private static final Set<String> FILTERED_SOUND_NAMES = new HashSet<>(Arrays.asList(
      ...
      "ENTITY_ENDERPEARL_THROW", "ENTITY_ENDER_PEARL_THROW",
   ...
   private static Entity getBukkitEntityById(World world, int entityId) {
      try {
         ...
         Object nmsEntity = worldHandle.getClass().getMethod("getEntity", int.class).invoke(worldHandle, entityId);
