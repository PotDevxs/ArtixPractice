...
public class v1_18_R2PacketListener extends AbstractPacketListener {
   private static final PacketType[] ENTITY_PACKETS;

   public v1_18_R2PacketListener(JavaPlugin plugin) {
   ...
   public Player getPlayerWhoDropped(Item item) {
      CraftWorld craftWorld = (CraftWorld)item.getWorld();
      UUID thrower = ((EntityItem)((CraftItem)item).getHandle()).j();
      if (thrower == null) {
         return null;
      } else {
         net.minecraft.world.entity.Entity entity = craftWorld.getHandle().a(thrower);
