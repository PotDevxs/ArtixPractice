...
public class v1_16_R3PacketListener extends AbstractPacketListener {
   ...
   public v1_16_R3PacketListener(JavaPlugin plugin) {
   ...
   public Player getPlayerWhoDropped(Item item) {
      try {
         ...
         UUID thrower = (UUID) handle.getClass().getMethod("getThrower").invoke(handle);
         return thrower == null ? null : Bukkit.getPlayer(thrower);
      } catch (Exception e) {
         return null;
      }
   }
