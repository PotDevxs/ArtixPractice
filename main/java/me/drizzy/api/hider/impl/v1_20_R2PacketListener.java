...
public class v1_20_R2PacketListener extends AbstractPacketListener {
   private static final PacketType[] ENTITY_PACKETS;

   public v1_20_R2PacketListener(JavaPlugin plugin) {
   ...
   public Player getPlayerWhoDropped(Item item) {
      net.minecraft.world.entity.Entity entity = ((CraftItem)item).getHandle().v();
