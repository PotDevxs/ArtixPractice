...
/**
 * Title Utils
 * Utility class for title operations using PaperSpigot
 */
public class TitleUtils {
   ...
   /**
    * Send title to player using PaperSpigot
    * @param player the player
   ...
   /**
    * Get title utils statistics
    * @return statistics
    */
   public String getStatistics() {
      return String.format("TitleUtils: Active, Online Players: %d", 
