...
public class ZortexSpigotListener implements Listener, IListener {
   ...
   public void onAdd(Object event) {
      ...
      try {
         ...
         Method getReason = potionEffectAddEventClass.getMethod("getReason");
         Object entity = getEntity.invoke(event);
         Object effect = getEffect.invoke(event);
         Object reason = getReason.invoke(event);
         RefinePotionAddEvent.EffectAddReason addReason = RefinePotionAddEvent.EffectAddReason.valueOf(reason.getClass().getMethod("name").invoke(reason).toString());
         RefinePotionAddEvent custom = new RefinePotionAddEvent((org.bukkit.entity.LivingEntity)entity, (org.bukkit.potion.PotionEffect)effect, addReason);
         Bukkit.getPluginManager().callEvent(custom);
      } catch (Exception e) {
         // Reflection failed
      }
   ...
   public void onExtend(Object event) {
      ...
      try {
         ...
         Method getReason = potionEffectExtendEventClass.getMethod("getReason");
         ...
         RefinePotionAddEvent.EffectAddReason addReason = RefinePotionAddEvent.EffectAddReason.valueOf(reason.getClass().getMethod("name").invoke(reason).toString());
         RefinePotionExtendEvent custom = new RefinePotionExtendEvent((org.bukkit.entity.LivingEntity)entity, (org.bukkit.potion.PotionEffect)effect, addReason, (org.bukkit.potion.PotionEffect)oldEffect);
         Bukkit.getPluginManager().callEvent(custom);
      } catch (Exception e) {
         // Reflection failed
      }
