...
public class CarbonSpigotListener implements Listener, IListener {
   ...
   public void onAdd(Object event) {
      ...
      try {
         ...
         Method getCause = potionEffectAddEventClass.getMethod("getCause");
         Object entity = getEntity.invoke(event);
         Object effect = getEffect.invoke(event);
         Object cause = getCause.invoke(event);
         RefinePotionAddEvent.EffectAddReason reason = RefinePotionAddEvent.EffectAddReason.valueOf(cause.getClass().getMethod("name").invoke(cause).toString());
   ...
   public void onExtend(Object event) {
      ...
      try {
         ...
         Method getCause = potionEffectExtendEventClass.getMethod("getCause");
