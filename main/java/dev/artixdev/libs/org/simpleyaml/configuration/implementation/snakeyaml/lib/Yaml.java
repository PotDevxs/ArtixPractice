...
import dev.artixdev.libs.org.simpleyaml.configuration.implementation.snakeyaml.lib.composer.Composer;
import dev.artixdev.libs.org.simpleyaml.configuration.implementation.snakeyaml.lib.constructor.BaseConstructor;
import dev.artixdev.libs.org.simpleyaml.configuration.implementation.snakeyaml.lib.constructor.Constructor;
import dev.artixdev.libs.org.simpleyaml.configuration.implementation.snakeyaml.lib.emitter.Emitable;
import dev.artixdev.libs.org.simpleyaml.configuration.implementation.snakeyaml.lib.emitter.Emitter;
...
import dev.artixdev.libs.org.simpleyaml.configuration.implementation.snakeyaml.lib.parser.ParserImpl;
import dev.artixdev.libs.org.simpleyaml.configuration.implementation.snakeyaml.lib.reader.StreamReader;
import dev.artixdev.libs.org.simpleyaml.configuration.implementation.snakeyaml.lib.reader.UnicodeReader;
...
import dev.artixdev.libs.org.simpleyaml.configuration.implementation.snakeyaml.lib.serializer.Serializer;
...
public class Yaml {
   ...
   public Yaml() {
      this((BaseConstructor)(new Constructor(new LoaderOptions())), (Representer)(new Representer(new DumperOptions())));
   }
   ...
   public Yaml(LoaderOptions loadingConfig) {
      this(new Constructor(loadingConfig), new Representer(new DumperOptions()), new DumperOptions(), (LoaderOptions)loadingConfig);
   }

   public Yaml(Representer representer) {
      this((BaseConstructor)(new Constructor(new LoaderOptions())), (Representer)representer);
   }
   ...
   public Iterable<Event> parse(Reader yaml) {
      final Parser parser = new ParserImpl(new StreamReader(yaml), this.loadingConfig);
