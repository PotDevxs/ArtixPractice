...
import dev.artixdev.libs.org.simpleyaml.configuration.implementation.snakeyaml.lib.serializer.AnchorGenerator;
import dev.artixdev.libs.org.simpleyaml.configuration.implementation.snakeyaml.lib.serializer.NumberAnchorGenerator;
...
public class DumperOptions {
   ...
   public static enum LineBreak {
      ...
      public static DumperOptions.LineBreak getPlatformLineBreak() {
         ...
         DumperOptions.LineBreak[] lineBreaks = values();
         int count = lineBreaks.length;

         for (int i = 0; i < count; ++i) {
            DumperOptions.LineBreak lb = lineBreaks[i];
