   ...
   public <T> T getValue(Class<T> clazz) {
      try {
         if (Long.class == clazz) {
            ...
            if (this.value instanceof Integer) {
               return clazz.cast(new Decimal128((long)(Integer)this.value));
            }
         ...
         throw new JsonParseException(String.format("Exception converting value '%s' to type %s", this.value, clazz.getName()), exception);
      }
   }
