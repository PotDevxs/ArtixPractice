...
public class ClassModelBuilder<T> {
   ...
   public boolean removeProperty(String propertyName) {
      return this.propertyModelBuilders.remove(this.getProperty((String)Assertions.notNull("propertyName", propertyName)));
   }

   public PropertyModelBuilder<?> getProperty(String propertyName) {
      Assertions.notNull("propertyName", propertyName);
      Iterator<PropertyModelBuilder<?>> iterator = this.propertyModelBuilders.iterator();
      ...
      do {
         ...
         propertyModelBuilder = iterator.next();
      } while(!propertyModelBuilder.getName().equals(propertyName));
   ...
   public ClassModel<T> build() {
      ...
      Iterator<Convention> conventionIterator = this.conventions.iterator();

      while(conventionIterator.hasNext()) {
         Convention convention = conventionIterator.next();
      ...
      Iterator<PropertyModelBuilder<?>> propertyIterator = this.propertyModelBuilders.iterator();

      while(propertyIterator.hasNext()) {
         PropertyModelBuilder<?> propertyModelBuilder = propertyIterator.next();
      ...
      return new ClassModel(this.type, this.propertyNameToTypeParameterMap, this.instanceCreatorFactory, this.discriminatorEnabled, this.discriminatorKey, this.discriminator, IdPropertyModelHolder.create(this.type, idPropertyModel, this.idGenerator), Collections.unmodifiableList(propertyModels));
   }
