...
import dev.artixdev.libs.com.google.gson.internal.bind.ArrayTypeAdapter;
import dev.artixdev.libs.com.google.gson.internal.bind.CollectionTypeAdapterFactory;
import dev.artixdev.libs.com.google.gson.internal.bind.DateTypeAdapter;
import dev.artixdev.libs.com.google.gson.internal.bind.JsonAdapterAnnotationTypeAdapterFactory;
...
import dev.artixdev.libs.com.google.gson.internal.bind.MapTypeAdapterFactory;
import dev.artixdev.libs.com.google.gson.internal.bind.NumberTypeAdapter;
import dev.artixdev.libs.com.google.gson.internal.bind.ObjectTypeAdapter;
import dev.artixdev.libs.com.google.gson.internal.bind.ReflectiveTypeAdapterFactory;
import dev.artixdev.libs.com.google.gson.internal.bind.SerializationDelegatingTypeAdapter;
import dev.artixdev.libs.com.google.gson.internal.bind.TypeAdapters;
import dev.artixdev.libs.com.google.gson.internal.sql.SqlTypesSupport;
...
public final class Gson {
   ...
   public <T> TypeAdapter<T> getAdapter(TypeToken<T> type) {
      ...
      if (cached != null) {
         ...
         if (threadCalls == null) {
            ...
            candidate = (TypeAdapter)((Map)threadCalls).get(type);
            if (candidate != null) {
         ...
         try {
            ...
            Iterator<TypeAdapterFactory> factoryIterator = this.factories.iterator();

            while (factoryIterator.hasNext()) {
               TypeAdapterFactory factory = factoryIterator.next();
               candidate = factory.create(this, type);
               if (candidate != null) {
                  call.setDelegate(candidate);
                  ((Map)threadCalls).put(type, candidate);
                  break;
               }
            }
         } finally {
   ...
   public void toJson(Object src, Type typeOfSrc, JsonWriter writer) throws JsonIOException {
      TypeAdapter<Object> adapter = (TypeAdapter<Object>) this.getAdapter(TypeToken.get(typeOfSrc));
   ...
   public <T> T fromJson(JsonReader reader, TypeToken<T> typeOfT) throws JsonIOException, JsonSyntaxException {
      ...
      try {
         ...
         result = typeAdapter.read(reader);
         return result;
   ...
   public <T> T fromJson(JsonElement json, TypeToken<T> typeOfT) throws JsonSyntaxException {
      return json == null ? null : this.fromJson((JsonReader)(new JsonTreeReader(json)), typeOfT);
   }
