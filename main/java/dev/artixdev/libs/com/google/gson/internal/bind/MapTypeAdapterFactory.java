...
import dev.artixdev.libs.com.google.gson.internal.JsonReaderInternalAccess;
      ...
      public void write(JsonWriter out, Map<K, V> map) throws IOException {
         if (map == null) {
            ...
            while (entryIterator.hasNext()) {
               Entry<K, V> entryx = entryIterator.next();
            ...
            for (Iterator<Entry<K, V>> entryIterator = map.entrySet().iterator(); entryIterator.hasNext(); hasComplexKeys |= keyElement.isJsonArray() || keyElement.isJsonObject()) {
