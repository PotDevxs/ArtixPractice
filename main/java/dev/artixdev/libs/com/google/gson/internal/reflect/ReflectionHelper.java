package dev.artixdev.libs.com.google.gson.internal.reflect;
...
public class ReflectionHelper {
   ...
   static {
      ...
      RECORD_HELPER = (ReflectionHelper.RecordHelper)instance;
   }
   ...
   private static class RecordNotSupportedHelper extends ReflectionHelper.RecordHelper {
      ...
      RecordNotSupportedHelper(Object ignored) {
         this();
      }
   }
   ...
   private static class RecordSupportedHelper extends ReflectionHelper.RecordHelper {
      ...
      RecordSupportedHelper(Object ignored) throws NoSuchMethodException {
         this();
      }
   }
