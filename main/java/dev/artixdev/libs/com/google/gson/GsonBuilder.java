...
import dev.artixdev.libs.com.google.gson.internal.$Gson$Preconditions;
import dev.artixdev.libs.com.google.gson.internal.Excluder;
import dev.artixdev.libs.com.google.gson.internal.bind.DefaultDateTypeAdapter;
import dev.artixdev.libs.com.google.gson.internal.bind.TreeTypeAdapter;
...
public final class GsonBuilder {
   ...
   public GsonBuilder setExclusionStrategies(ExclusionStrategy... strategies) {
      ...
      ExclusionStrategy[] strategiesArray = strategies;
      int strategiesLength = strategies.length;

      for (int i = 0; i < strategiesLength; ++i) {
         ExclusionStrategy strategy = strategiesArray[i];
