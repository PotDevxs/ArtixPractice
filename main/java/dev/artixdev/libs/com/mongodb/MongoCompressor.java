...
public final class MongoCompressor {
   ...
   public <T> T getProperty(String key, T defaultValue) {
      ...
      Object raw = this.properties.get(key.toLowerCase());
      return (raw == null && !this.properties.containsKey(key)) ? defaultValue : (T) raw;
   }
   ...
   public boolean equals(Object o) {
      if (this == o) {
         ...
         return !this.name.equals(that.name) ? false : this.properties.equals(that.properties);
      } else {
         return false;
      }
   }
