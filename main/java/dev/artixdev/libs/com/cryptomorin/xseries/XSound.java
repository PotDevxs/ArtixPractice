...
public enum XSound {
   ...
   ENTITY_LIGHTNING_ARTIX_IMPACT(new String[]{"AMBIENCE_THUNDER", "ENTITY_LIGHTNING_IMPACT"}),
   ENTITY_LIGHTNING_ARTIX_THUNDER(new String[]{"AMBIENCE_THUNDER", "ENTITY_LIGHTNING_THUNDER"}),
