...
import dev.artixdev.libs.it.unimi.dsi.fastutil.ints.Int2IntFunction;
...
@FunctionalInterface
public interface Reference2IntFunction<K> extends ToIntFunction<K>, Function<K, Integer> {
