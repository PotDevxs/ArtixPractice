...
public final class ByteArrays {
   ...
   public static void quickSort(byte[] x, int from, int to) {
      ...
      if (len < 16) {
         ...
         while(true) {
            int s;
            while(b > c || (s = Byte.compare(x[b], v)) > 0) {
               for(; c >= b && (s = Byte.compare(x[c], v)) >= 0; --c) {
                  if (s == 0) {
                     swap(x, c, d--);
                  }
               }
   ...
   public static void quickSortIndirect(int[] perm, byte[] x, int from, int to) {
      ...
      if (len < 16) {
         ...
         while(true) {
            int s;
            while(b > c || (s = Byte.compare(x[perm[b]], v)) > 0) {
               for(; c >= b && (s = Byte.compare(x[perm[c]], v)) >= 0; --c) {
                  if (s == 0) {
   ...
   public static void quickSort(byte[] x, byte[] y, int from, int to) {
      ...
      if (len < 16) {
         ...
         while(true) {
            int s;
            int t;
            while(b > c || (s = (t = Byte.compare(x[b], v)) == 0 ? Byte.compare(y[b], w) : t) > 0) {
               for(; c >= b && (s = (t = Byte.compare(x[c], v)) == 0 ? Byte.compare(y[c], w) : t) >= 0; --c) {
                  if (s == 0) {
                     swap(x, y, c, d--);
                  }
               }
                  ...
                  for(boolean var15 = true; i <= end; count[c] = 0) {
                     ...
                     if (level < 0 && count[c] > 1) {
                        if (count[c] < 1024) {
                           ...
                           queue.add(new ByteArrays.Segment(i, count[c], level + 1));
                        }
                     }
                     ...
                     for(ix = first; i <= lastUsed; ++i) {
                        if (level < 0 && count[i] > 1) {
                           if (count[i] < 1024) {
                              ...
                              queueSize.incrementAndGet();
                              queue.add(new ByteArrays.Segment(ix, count[i], level + 1));
                           }
                        }
                     ...
                     for(boolean var18 = true; ix <= i; count[c] = 0) {
                        ...
                        if (level < 0 && count[c] > 1) {
                           if (count[c] < 1024) {
                              ...
                              queueSize.incrementAndGet();
                              queue.add(new ByteArrays.Segment(ix, count[c], level + 1));
                           }
                        }
            ...
            while(true) {
               ...
               while(b > c || (t = this.comp.compare(x[b], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new ByteArrays.ForkJoinQuickSortComp(x, this.from, this.from + s, this.comp), new ByteArrays.ForkJoinQuickSortComp(x, this.to - t, this.to, this.comp));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSortComp(x, this.from, this.from + s, this.comp)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSortComp(x, this.to - t, this.to, this.comp)});
                     }
   ...
   protected static class ForkJoinQuickSort extends RecursiveAction {
      ...
      protected void compute() {
         ...
         if (len < 8192) {
            ...
            while(true) {
               int t;
               while(b > c || (t = Byte.compare(x[b], v)) > 0) {
                  for(; c >= b && (t = Byte.compare(x[c], v)) >= 0; --c) {
                     if (t == 0) {
                        ByteArrays.swap(x, c, d--);
                     }
                  }
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new ByteArrays.ForkJoinQuickSort(x, this.from, this.from + s), new ByteArrays.ForkJoinQuickSort(x, this.to - t, this.to));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSort(x, this.from, this.from + s)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSort(x, this.to - t, this.to)});
                     }
   ...
   protected static class ForkJoinQuickSortIndirect extends RecursiveAction {
      ...
      protected void compute() {
         ...
         if (len < 8192) {
            ...
            while(true) {
               int t;
               while(b > c || (t = Byte.compare(x[this.perm[b]], v)) > 0) {
                  for(; c >= b && (t = Byte.compare(x[this.perm[c]], v)) >= 0; --c) {
                     if (t == 0) {
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new ByteArrays.ForkJoinQuickSortIndirect(this.perm, x, this.from, this.from + s), new ByteArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - t, this.to));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSortIndirect(this.perm, x, this.from, this.from + s)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - t, this.to)});
                     }
            ...
            while(true) {
               ...
               while(b > c || (t = (t = Byte.compare(x[b], v)) == 0 ? Byte.compare(y[b], w) : t) > 0) {
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new ByteArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s), new ByteArrays.ForkJoinQuickSort2(x, y, this.to - t, this.to));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSort2(x, y, this.to - t, this.to)});
                     }
