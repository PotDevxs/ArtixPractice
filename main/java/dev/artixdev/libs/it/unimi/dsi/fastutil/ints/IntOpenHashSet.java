...
public class IntOpenHashSet extends AbstractIntSet implements Serializable, Cloneable, Hash {
   ...
   public static IntOpenHashSet toSet(IntStream stream) {
      return (IntOpenHashSet)stream.collect(IntOpenHashSet::new, IntOpenHashSet::add, IntOpenHashSet::addAll);
   }
   ...
   private final class SetSpliterator implements IntSpliterator {
      ...
      public long estimateSize() {
         return !this.hasSplit ? (long)(IntOpenHashSet.this.size - this.c) : Math.min((long)(IntOpenHashSet.this.size - this.c), (long)((double)IntOpenHashSet.this.realSize() / (double)IntOpenHashSet.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
      }
