...
public final class IntComparators {
   ...
   protected static class OppositeComparator implements Serializable, IntComparator {
   ...
   protected static class NaturalImplicitComparator implements Serializable, IntComparator {
      private static final long serialVersionUID = 1L;
   ...
   protected static class OppositeImplicitComparator implements Serializable, IntComparator {
      private static final long serialVersionUID = 1L;
