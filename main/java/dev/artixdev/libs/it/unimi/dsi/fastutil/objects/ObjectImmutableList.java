...
public class ObjectImmutableList<K> extends ObjectLists.ImmutableListBase<K> implements Serializable, Cloneable, RandomAccess, ObjectList<K> {
   ...
   private static final class ImmutableSubList<K> extends ObjectLists.ImmutableListBase<K> implements Serializable, RandomAccess {
