...
import dev.artixdev.libs.it.unimi.dsi.fastutil.longs.LongCollections;
import dev.artixdev.libs.it.unimi.dsi.fastutil.longs.LongSets;
...
public final class Object2LongMaps {
   ...
   public static <K> ObjectIterable<Object2LongMap.Entry<K>> fastIterable(Object2LongMap<K> map) {
      ...
      return (ObjectIterable)(entries instanceof Object2LongMap.FastEntrySet ? new ObjectIterable<Object2LongMap.Entry<K>>() {
   ...
   public static class EmptyMap<K> extends Object2LongFunctions.EmptyFunction<K> implements Serializable, Cloneable, Object2LongMap<K> {
   ...
   public static class Singleton<K> extends Object2LongFunctions.Singleton<K> implements Serializable, Cloneable, Object2LongMap<K> {
      private static final long serialVersionUID = -7046029254386353129L;
   ...
   public static class SynchronizedMap<K> extends Object2LongFunctions.SynchronizedFunction<K> implements Serializable, Object2LongMap<K> {
      private static final long serialVersionUID = -7046029254386353129L;
      ...
      public Long computeIfAbsent(K key, Function<? super K, ? extends Long> mappingFunction) {
         synchronized(this.sync) {
            return (Long)this.map.computeIfAbsent(key, (Function)mappingFunction);
         }
      }
   ...
   public static class UnmodifiableMap<K> extends Object2LongFunctions.UnmodifiableFunction<K> implements Serializable, Object2LongMap<K> {
      private static final long serialVersionUID = -7046029254386353129L;
