            ...
            while(true) {
               ...
               while(b > c || (t = this.comp.compare(x[b], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new ObjectArrays.ForkJoinQuickSortComp(x, this.from, this.from + s, this.comp), new ObjectArrays.ForkJoinQuickSortComp(x, this.to - t, this.to, this.comp));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ObjectArrays.ForkJoinQuickSortComp(x, this.from, this.from + s, this.comp)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ObjectArrays.ForkJoinQuickSortComp(x, this.to - t, this.to, this.comp)});
                     }
   ...
   protected static class ForkJoinQuickSort<K> extends RecursiveAction {
      ...
      protected void compute() {
         ...
         if (len < 8192) {
            ...
            while(true) {
               int t;
               while(b > c || (t = ((Comparable)x[b]).compareTo(v)) > 0) {
                  for(; c >= b && (t = ((Comparable)x[c]).compareTo(v)) >= 0; --c) {
                     if (t == 0) {
                        ObjectArrays.swap(x, c, d--);
                     }
                  }
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new ObjectArrays.ForkJoinQuickSort(x, this.from, this.from + s), new ObjectArrays.ForkJoinQuickSort(x, this.to - t, this.to));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ObjectArrays.ForkJoinQuickSort(x, this.from, this.from + s)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ObjectArrays.ForkJoinQuickSort(x, this.to - t, this.to)});
                     }
   ...
   protected static class ForkJoinQuickSortIndirect<K> extends RecursiveAction {
      ...
      protected void compute() {
         ...
         if (len < 8192) {
            ...
            while(true) {
               int t;
               while(b > c || (t = ((Comparable)x[this.perm[b]]).compareTo(v)) > 0) {
                  for(; c >= b && (t = ((Comparable)x[this.perm[c]]).compareTo(v)) >= 0; --c) {
                     if (t == 0) {
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new ObjectArrays.ForkJoinQuickSortIndirect(this.perm, x, this.from, this.from + s), new ObjectArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - t, this.to));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ObjectArrays.ForkJoinQuickSortIndirect(this.perm, x, this.from, this.from + s)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ObjectArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - t, this.to)});
                     }
            ...
            while(true) {
               ...
               while(b > c || (t = (t = ((Comparable)x[b]).compareTo(v)) == 0 ? ((Comparable)y[b]).compareTo(w) : t) > 0) {
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new ObjectArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s), new ObjectArrays.ForkJoinQuickSort2(x, y, this.to - t, this.to));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ObjectArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ObjectArrays.ForkJoinQuickSort2(x, y, this.to - t, this.to)});
                     }
