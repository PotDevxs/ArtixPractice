...
public final class ShortArrays {
   ...
   public static void quickSort(short[] x, int from, int to) {
      ...
      if (len < 16) {
         ...
         while(true) {
            int s;
            while(b > c || (s = Short.compare(x[b], v)) > 0) {
               for(; c >= b && (s = Short.compare(x[c], v)) >= 0; --c) {
                  if (s == 0) {
                     swap(x, c, d--);
                  }
               }
   ...
   public static void quickSortIndirect(int[] perm, short[] x, int from, int to) {
      ...
      if (len < 16) {
         ...
         while(true) {
            int s;
            while(b > c || (s = Short.compare(x[perm[b]], v)) > 0) {
               for(; c >= b && (s = Short.compare(x[perm[c]], v)) >= 0; --c) {
                  if (s == 0) {
   ...
   public static void quickSort(short[] x, short[] y, int from, int to) {
      ...
      if (len < 16) {
         ...
         while(true) {
            int s;
            int t;
            while(b > c || (s = (t = Short.compare(x[b], v)) == 0 ? Short.compare(y[b], w) : t) > 0) {
               for(; c >= b && (s = (t = Short.compare(x[c], v)) == 0 ? Short.compare(y[c], w) : t) >= 0; --c) {
                  if (s == 0) {
                     swap(x, y, c, d--);
                  }
               }
   ...
   public static void mergeSort(short[] a, int from, int to, ShortComparator comp) {
      mergeSort(a, from, to, comp, (short[])null);
   }

   public static void mergeSort(short[] a, ShortComparator comp) {
      mergeSort(a, 0, a.length, (ShortComparator)comp);
   }
                  ...
                  for(boolean var15 = true; i <= end; count[c] = 0) {
                     ...
                     if (level < 1 && count[c] > 1) {
                        if (count[c] < 1024) {
                           ...
                           queue.add(new ShortArrays.Segment(i, count[c], level + 1));
                        }
                     }
                     ...
                     for(ix = first; i <= lastUsed; ++i) {
                        if (level < 1 && count[i] > 1) {
                           if (count[i] < 1024) {
                              ...
                              queueSize.incrementAndGet();
                              queue.add(new ShortArrays.Segment(ix, count[i], level + 1));
                           }
                        }
                     ...
                     for(boolean var18 = true; ix <= i; count[c] = 0) {
                        ...
                        if (level < 1 && count[c] > 1) {
                           if (count[c] < 1024) {
                              ...
                              queueSize.incrementAndGet();
                              queue.add(new ShortArrays.Segment(ix, count[c], level + 1));
                           }
                        }
   ...
   private static void selectionSort(short[][] a, int from, int to, int level) {
      ...
      for(int i = from; i < to - 1; ++i) {
         ...
         int p;
         for(p = i + 1; p < to; ++p) {
            for(int r = firstLayer; r < layers; ++r) {
               if (a[r][p] < a[r][m]) {
                  m = p;
                  break;
               }
   ...
   public static void radixSort(short[][] a) {
      radixSort((short[][])a, 0, a[0].length);
   }
            ...
            while(true) {
               ...
               while(b > c || (t = this.comp.compare(x[b], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new ShortArrays.ForkJoinQuickSortComp(x, this.from, this.from + s, this.comp), new ShortArrays.ForkJoinQuickSortComp(x, this.to - t, this.to, this.comp));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSortComp(x, this.from, this.from + s, this.comp)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSortComp(x, this.to - t, this.to, this.comp)});
                     }
   ...
   protected static class ForkJoinQuickSort extends RecursiveAction {
      ...
      protected void compute() {
         ...
         if (len < 8192) {
            ...
            while(true) {
               int t;
               while(b > c || (t = Short.compare(x[b], v)) > 0) {
                  for(; c >= b && (t = Short.compare(x[c], v)) >= 0; --c) {
                     if (t == 0) {
                        ShortArrays.swap(x, c, d--);
                     }
                  }
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new ShortArrays.ForkJoinQuickSort(x, this.from, this.from + s), new ShortArrays.ForkJoinQuickSort(x, this.to - t, this.to));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSort(x, this.from, this.from + s)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSort(x, this.to - t, this.to)});
                     }
   ...
   protected static class ForkJoinQuickSortIndirect extends RecursiveAction {
      ...
      protected void compute() {
         ...
         if (len < 8192) {
            ...
            while(true) {
               int t;
               while(b > c || (t = Short.compare(x[this.perm[b]], v)) > 0) {
                  for(; c >= b && (t = Short.compare(x[this.perm[c]], v)) >= 0; --c) {
                     if (t == 0) {
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new ShortArrays.ForkJoinQuickSortIndirect(this.perm, x, this.from, this.from + s), new ShortArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - t, this.to));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSortIndirect(this.perm, x, this.from, this.from + s)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - t, this.to)});
                     }
   ...
   protected static class ForkJoinQuickSort2 extends RecursiveAction {
      ...
      protected void compute() {
         ...
         if (len < 8192) {
            ...
            while(true) {
               int t;
               while(b > c || (t = (t = Short.compare(x[b], v)) == 0 ? Short.compare(y[b], w) : t) > 0) {
                  for(; c >= b && (t = (t = Short.compare(x[c], v)) == 0 ? Short.compare(y[c], w) : t) >= 0; --c) {
                     if (t == 0) {
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new ShortArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s), new ShortArrays.ForkJoinQuickSort2(x, y, this.to - t, this.to));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSort2(x, y, this.to - t, this.to)});
                     }
   ...
   private static final class ArrayHashStrategy implements Serializable, Hash.Strategy<short[]> {
