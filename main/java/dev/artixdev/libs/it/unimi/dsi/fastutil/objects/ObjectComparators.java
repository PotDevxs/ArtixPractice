...
public final class ObjectComparators {
   ...
   public static <K> Comparator<K> oppositeComparator(Comparator<K> c) {
      return (Comparator)(c instanceof ObjectComparators.OppositeComparator ? ((ObjectComparators.OppositeComparator)c).comparator : new ObjectComparators.OppositeComparator(c));
   }
   ...
   protected static class OppositeComparator<K> implements Serializable, Comparator<K> {
