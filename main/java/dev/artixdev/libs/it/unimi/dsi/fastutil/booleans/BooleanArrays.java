...
public final class BooleanArrays {
   ...
   public static void parallelQuickSort(boolean[] x, int from, int to, BooleanComparator comp) {
      ...
      if (to - from >= 8192 && pool.getParallelism() != 1) {
         pool.invoke(new BooleanArrays.ForkJoinQuickSortComp(x, from, to, comp));
      } else {
   ...
   public static void quickSort(boolean[] x, int from, int to) {
      ...
      if (len < 16) {
         ...
         while(true) {
            int s;
            while(b > c || (s = Boolean.compare(x[b], v)) > 0) {
               for(; c >= b && (s = Boolean.compare(x[c], v)) >= 0; --c) {
                  if (s == 0) {
                     swap(x, c, d--);
                  }
               }
   ...
   public static void parallelQuickSort(boolean[] x, int from, int to) {
      ForkJoinPool pool = getPool();
      if (to - from >= 8192 && pool.getParallelism() != 1) {
         pool.invoke(new BooleanArrays.ForkJoinQuickSort(x, from, to));
      } else {
         quickSort(x, from, to);
      }
   ...
   public static void quickSortIndirect(int[] perm, boolean[] x, int from, int to) {
      ...
      if (len < 16) {
         ...
         while(true) {
            int s;
            while(b > c || (s = Boolean.compare(x[perm[b]], v)) > 0) {
               for(; c >= b && (s = Boolean.compare(x[perm[c]], v)) >= 0; --c) {
                  if (s == 0) {
   ...
   public static void parallelQuickSortIndirect(int[] perm, boolean[] x, int from, int to) {
      ForkJoinPool pool = getPool();
      if (to - from >= 8192 && pool.getParallelism() != 1) {
         pool.invoke(new BooleanArrays.ForkJoinQuickSortIndirect(perm, x, from, to));
      } else {
   ...
   public static void quickSort(boolean[] x, boolean[] y, int from, int to) {
      ...
      if (len < 16) {
         ...
         while(true) {
            int s;
            int t;
            while(b > c || (s = (t = Boolean.compare(x[b], v)) == 0 ? Boolean.compare(y[b], w) : t) > 0) {
               for(; c >= b && (s = (t = Boolean.compare(x[c], v)) == 0 ? Boolean.compare(y[c], w) : t) >= 0; --c) {
                  if (s == 0) {
                     swap(x, y, c, d--);
                  }
               }
   ...
   public static void parallelQuickSort(boolean[] x, boolean[] y, int from, int to) {
      ForkJoinPool pool = getPool();
      if (to - from >= 8192 && pool.getParallelism() != 1) {
         pool.invoke(new BooleanArrays.ForkJoinQuickSort2(x, y, from, to));
      } else {
            ...
            while(true) {
               ...
               while(b > c || (t = this.comp.compare(x[b], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new BooleanArrays.ForkJoinQuickSortComp(x, this.from, this.from + s, this.comp), new BooleanArrays.ForkJoinQuickSortComp(x, this.to - t, this.to, this.comp));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSortComp(x, this.from, this.from + s, this.comp)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSortComp(x, this.to - t, this.to, this.comp)});
                     }
   ...
   protected static class ForkJoinQuickSort extends RecursiveAction {
      ...
      protected void compute() {
         ...
         if (len < 8192) {
            ...
            while(true) {
               int t;
               while(b > c || (t = Boolean.compare(x[b], v)) > 0) {
                  for(; c >= b && (t = Boolean.compare(x[c], v)) >= 0; --c) {
                     if (t == 0) {
                        BooleanArrays.swap(x, c, d--);
                     }
                  }
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new BooleanArrays.ForkJoinQuickSort(x, this.from, this.from + s), new BooleanArrays.ForkJoinQuickSort(x, this.to - t, this.to));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSort(x, this.from, this.from + s)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSort(x, this.to - t, this.to)});
                     }
   ...
   protected static class ForkJoinQuickSortIndirect extends RecursiveAction {
      ...
      protected void compute() {
         ...
         if (len < 8192) {
            ...
            while(true) {
               int t;
               while(b > c || (t = Boolean.compare(x[this.perm[b]], v)) > 0) {
                  for(; c >= b && (t = Boolean.compare(x[this.perm[c]], v)) >= 0; --c) {
                     if (t == 0) {
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new BooleanArrays.ForkJoinQuickSortIndirect(this.perm, x, this.from, this.from + s), new BooleanArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - t, this.to));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSortIndirect(this.perm, x, this.from, this.from + s)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - t, this.to)});
                     }
   ...
   protected static class ForkJoinQuickSort2 extends RecursiveAction {
      ...
      protected void compute() {
         ...
         if (len < 8192) {
            ...
            while(true) {
               int t;
               while(b > c || (t = (t = Boolean.compare(x[b], v)) == 0 ? Boolean.compare(y[b], w) : t) > 0) {
                  for(; c >= b && (t = (t = Boolean.compare(x[c], v)) == 0 ? Boolean.compare(y[c], w) : t) >= 0; --c) {
                     if (t == 0) {
                  ...
                  if (b > c) {
                     ...
                     t = d - c;
                     if (s > 1 && t > 1) {
                        invokeAll(new BooleanArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s), new BooleanArrays.ForkJoinQuickSort2(x, y, this.to - t, this.to));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSort2(x, y, this.to - t, this.to)});
                     }
