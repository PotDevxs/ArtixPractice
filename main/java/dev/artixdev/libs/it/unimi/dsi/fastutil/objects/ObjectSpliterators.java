...
public final class ObjectSpliterators {
   ...
   public static <K> ObjectSpliterator<K> asObjectSpliterator(Spliterator<K> i) {
      return (ObjectSpliterator)(i instanceof ObjectSpliterator ? (ObjectSpliterator)i : new ObjectSpliterators.SpliteratorWrapper(i));
   }
   ...
   public static class EmptySpliterator<K> implements Serializable, Cloneable, ObjectSpliterator<K> {
      ...
      public long skip(long n) {
         if (n < 0L) {
            ...
            if (this.iter instanceof ObjectBigListIterator) {
               skippedSoFar = ((ObjectBigListIterator)this.iter).skip(n);
   ...
   private static final class IteratorFromSpliterator<K> implements Consumer<K>, ObjectIterator<K> {
