...
public final class LongSpliterators {
   ...
   public static LongSpliterator asLongSpliterator(Spliterator i) {
      if (i instanceof LongSpliterator) {
         ...
         return (LongSpliterator)(i instanceof OfLong ? new LongSpliterators.PrimitiveSpliteratorWrapper((OfLong)i) : new LongSpliterators.SpliteratorWrapper(i));
      }
   }
   ...
   public static LongSpliterator asLongSpliterator(Spliterator i, LongComparator comparatorOverride) {
      if (i instanceof LongSpliterator) {
         ...
         return (LongSpliterator)(i instanceof OfLong ? new LongSpliterators.PrimitiveSpliteratorWrapperWithComparator((OfLong)i, comparatorOverride) : new LongSpliterators.SpliteratorWrapperWithComparator(i, comparatorOverride));
      }
   }
      ...
      public long skip(long n) {
         if (n < 0L) {
            ...
            if (this.iter instanceof LongBigListIterator) {
               skippedSoFar = ((LongBigListIterator)this.iter).skip(n);
   ...
   private static final class IteratorFromSpliterator implements LongConsumer, LongIterator {
   ...
   public static class EmptySpliterator implements Serializable, Cloneable, LongSpliterator {
