...
public interface Object2IntMap<K> extends Map<K, Integer>, Object2IntFunction<K> {
   int size();
   ...
   default int mergeInt(K key, int value, dev.artixdev.libs.it.unimi.dsi.fastutil.ints.IntBinaryOperator remappingFunction) {
