...
public class IntArrayList extends AbstractIntList implements Serializable, Cloneable, RandomAccess {
   ...
   public static IntArrayList toList(IntStream stream) {
      return (IntArrayList)stream.collect(IntArrayList::new, IntArrayList::add, IntList::addAll);
   }
   ...
   public boolean addAll(int index, IntCollection c) {
      if (c instanceof IntList) {
         ...
         if (n == 0) {
            ...
            for(this.size += n; n-- != 0; this.a[index++] = i.nextInt()) {
            }
   ...
   public int compareTo(List<? extends Integer> l) {
      if (l instanceof IntArrayList) {
         ...
         return l instanceof IntArrayList.SubList ? -((IntArrayList.SubList)l).compareTo((List)this) : super.compareTo(l);
      }
   }
   ...
   private class SubList extends AbstractIntList.IntRandomAccessSubList {
      ...
      boolean contentsEquals(int[] otherA, int otherAFrom, int otherATo) {
         if (IntArrayList.this.a == otherA && this.from == otherAFrom && this.to == otherATo) {
            ...
            } while(IntArrayList.this.a[pos++] == otherA[var5++]);
      ...
      public boolean equals(Object o) {
         if (o == this) {
            ...
            IntArrayList.SubList otherx = (IntArrayList.SubList)o;
      ...
      public int compareTo(List<? extends Integer> l) {
         if (l instanceof IntArrayList) {
            ...
            IntArrayList.SubList otherx = (IntArrayList.SubList)l;
