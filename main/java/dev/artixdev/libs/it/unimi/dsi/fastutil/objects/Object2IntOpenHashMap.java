...
import dev.artixdev.libs.it.unimi.dsi.fastutil.ints.AbstractIntCollection;
...
public class Object2IntOpenHashMap<K> extends AbstractObject2IntMap<K> implements Serializable, Cloneable, Hash {
   ...
   final class MapEntry implements java.util.Map.Entry<K, Integer>, Object2IntMap.Entry<K>, ObjectIntPair<K> {
      int index;
