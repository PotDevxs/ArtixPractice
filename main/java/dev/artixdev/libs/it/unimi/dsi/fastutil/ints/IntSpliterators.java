...
import dev.artixdev.libs.it.unimi.dsi.fastutil.bytes.ByteSpliterator;
import dev.artixdev.libs.it.unimi.dsi.fastutil.chars.CharSpliterator;
import dev.artixdev.libs.it.unimi.dsi.fastutil.shorts.ShortSpliterator;
...
public final class IntSpliterators {
   ...
   public static IntSpliterator asIntSpliterator(Spliterator i, IntComparator comparatorOverride) {
      if (i instanceof IntSpliterator) {
         ...
         return (IntSpliterator)(i instanceof OfInt ? new IntSpliterators.PrimitiveSpliteratorWrapperWithComparator((OfInt)i, comparatorOverride) : new IntSpliterators.SpliteratorWrapperWithComparator(i, comparatorOverride));
      }
   }
   ...
   public static IntSpliterator wrap(ByteSpliterator spliterator) {
      return new IntSpliterators.ByteSpliteratorWrapper(spliterator);
   }

   public static IntSpliterator wrap(ShortSpliterator spliterator) {
      return new IntSpliterators.ShortSpliteratorWrapper(spliterator);
   }

   public static IntSpliterator wrap(CharSpliterator spliterator) {
      return new IntSpliterators.CharSpliteratorWrapper(spliterator);
   }
   ...
   private static class SpliteratorWrapper implements IntSpliterator {
      ...
      public boolean tryAdvance(java.util.function.IntConsumer action) {
         Objects.requireNonNull(action);
         return this.i.tryAdvance((Integer x) -> action.accept(x));
      }
   ...
   private static class SpliteratorConcatenator implements IntSpliterator {
      ...
      private long recomputeRemaining() {
         ...
         do {
            ...
            result += cur;
         } while(result != Long.MAX_VALUE && result >= 0L);
      ...
      public long skip(long n) {
         if (n < 0L) {
            ...
            if (this.iter instanceof IntBigListIterator) {
               skippedSoFar = ((IntBigListIterator)this.iter).skip(n);
               this.size -= skippedSoFar;
               return skippedSoFar;
            } else {
               int skipped;
   ...
   private static final class IteratorFromSpliterator implements IntConsumer, IntIterator {
   ...
   private static final class ByteSpliteratorWrapper implements IntSpliterator {
      ...
      public IntSpliterator trySplit() {
         ...
         return possibleSplit == null ? null : new IntSpliterators.ByteSpliteratorWrapper(possibleSplit);
      }
   }
   ...
   private static final class ShortSpliteratorWrapper implements IntSpliterator {
      ...
      public IntSpliterator trySplit() {
         ...
         return possibleSplit == null ? null : new IntSpliterators.ShortSpliteratorWrapper(possibleSplit);
      }
   }
   ...
   private static final class CharSpliteratorWrapper implements IntSpliterator {
      ...
      public IntSpliterator trySplit() {
         ...
         return possibleSplit == null ? null : new IntSpliterators.CharSpliteratorWrapper(possibleSplit);
      }
   }

   public static class EmptySpliterator implements Serializable, Cloneable, IntSpliterator {
